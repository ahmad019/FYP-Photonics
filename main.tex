...
\paragraph{\normalfont In this project, we have investigated the optical characteristics of coupled ring resonators, which may be either active (containing a gain element) or passive. In the case of passive coupled resonators, intrinsic and coupling losses affect the circulation, transmission and dispersion of an input optical pulse. However, for active coupled resonators, gain excitation may be used to compensate for the losses. This alters the the spectral and dispersive properties of the coupled-resonator system owing to enhancement of the quality factor of the system. We demonstrated gain tunable all-optical analogs of Electromagnetically Induced Transparency (EIT) and Electromagnetically Induced Absorption (EIA). This allows us to precisely control the subluminal and superluminal group velocities of light pulses. Furthermore, we demonstrate gain-mediated reversible transition between the sub and superluminal dispersion regimes.}
